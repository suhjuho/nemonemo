...
### 2-1. 큐브 컴포넌트 geometry, material 재사용
...
### 2-2. useFrame 훅을 사용해 카메라 위치

초기 퍼즐을 확인하기 위해 퍼즐의 뒷면에는 격자무늬 배경이 존재합니다.
퍼즐을 지우거나 레이어 이동을 하면 해당 배경을 확인할 수 있습니다.

카메라 위치에 따라 퍼즐의 뒤쪽에 있는 격자무늬 배경이 조건부 렌더링이 되어야 합니다.
